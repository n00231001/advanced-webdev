<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 py-12 bg-gradient-to-r from-orange-400 bg-gradient-to-r from-cyan-500 to-red-500">
        ...
        <div class="flex justify-between h-16 ">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex text-gray-800">
                    ...
                    <x-nav-link :href="route('guitars.index')" :active="request()->routeIs('guitars.index')">
                        {{ __('View All Guitars') }}
                    </x-nav-link>
